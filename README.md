...
| Badge | Requirement |
|---------|-------------|
| 🌱 Quantum Ranger | 10 Points |
| 🥗 Plant Food Overlord | 120 Points |
| 🚲 Tachyon Transit Rider | 200 Points |
| ⚡ Fusion Grid Master | 350 Points |
| 👑 EcoSphere Sovereign | 500 Points |
...
```bash
git clone https://github.com/YOUR_USERNAME/ecosphere-carbon-tracker.git
